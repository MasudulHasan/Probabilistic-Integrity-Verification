...
#count =0 
#p_count = 0
#with open("dataset.csv","r") as in_file:
#        for line in in_file:
##            print(line)
#            count+=1
#            parts = line.split(",")
...
#hdd = pd.read_csv('../dataset_2017/dataset_ST12000NM0007.csv')
#hdd = pd.read_csv('../dataset_2017/dataset_ST8000NM0055.csv')
hdd = pd.read_csv('../dataset_2017/2/ST4000DM000.csv')
#hdd = hdd.dropna()
#print(hdd.iloc[0]) 
