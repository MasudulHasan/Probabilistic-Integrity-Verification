...
for part in range(2):
    stripe_size = 50
    if start_day==1:
        output_file = open("../result_log/model_simulation_new/"+str(disk_model_name)+"_"+str(month)+"_first.txt","a+")
    else:
        output_file = open("../result_log/model_simulation_new/"+str(disk_model_name)+"_"+str(month)+"_second.txt","a+")
