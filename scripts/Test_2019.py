...
out_file = open("../result_2019/result_"+str(day)+".txt","a+")
# print(folder_list)
...
for x in folder_list:
  try:
    ...
    if model_name in selected_models:
      ...
      test_hdd = test_hdd.drop(test_hdd.columns[14], axis=1)
      test_hdd = test_hdd.drop(test_hdd.columns[13], axis=1)
      test_hdd = test_hdd.dropna()
      
      test_hdd_pos = test_hdd.loc[test_hdd[test_hdd.columns[12]] == 1]
      test_hdd_neg = test_hdd[test_hdd[test_hdd.columns[12]] == 0]
