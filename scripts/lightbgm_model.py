...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 12 18:18:29 2020
...
for day in range(1,4):
    ...
    out_file = open("../final_result/"+str(day)+"/lightbgm.txt","a+")
...
#                clf.fit(X_resampled,y_resampled)
                ...
                clf = LGBMClassifier().fit(X_resampled,y_resampled)
...
#                plt.savefig("../final_result/"+str(day)+"/"+model_name+"_rf.png")
                ...
                dump(clf, '../ml_models/'+model_name+'_'+day+'_lightbgm.joblib') 
